...
class MaterialWrapper(juniper.types.wrappers.type_wrapper.TypeWrapper):
    ...
    def _get_name(self):
        ...
        package_name = tools_library.jdcc.scene.get_current().name
        output = output.replace("{package}", package_name)
        return output
    ...
    def _get_base_name(self):
        return tools_library.jdcc.scene.get_current().name
    ...
    def _get_path(self):
        return tools_library.jdcc.scene.get_current().path
    ...
    def __validate_exported_texture(self, texture_type, texture_path):
        ...
        new_fp = old_fp.replace("{package}", tools_library.jdcc.scene.get_current().name)
