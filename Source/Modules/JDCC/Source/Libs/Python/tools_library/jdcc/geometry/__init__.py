...
class GeometryWrapper(juniper.types.wrappers.type_wrapper.TypeWrapper):
    ...
    def load_asset_interface(self, asset_data_path):
        ...
        """
        if(asset_data_path):
            self.asset_interface = tools_library.jdcc.types.data.asset_interface.AssetInterface(
                asset_data_path,
                create_if_invalid=True
            )
        else:
            self.asset_interface = tools_library.jdcc.types.data.asset_interface.AssetInterface("", create_if_invalid=False)
    ...
    def __export(self):
        ...
        if(isinstance(self.native_object, tools_library.jdcc.scene.SceneWrapper)):
        ...
        elif(isinstance(self.native_object, tools_library.jdcc.scene.selection_set_wrapper.SelectionSetWrapper)):
            success = max_export.export_nodes(
                [x.native_object for x in self.native_object.objects],
                export_output_path
            )
        ...
        elif(isinstance(self.native_object, tools_library.jdcc.scene.object_wrapper.ObjectWrapper)):
